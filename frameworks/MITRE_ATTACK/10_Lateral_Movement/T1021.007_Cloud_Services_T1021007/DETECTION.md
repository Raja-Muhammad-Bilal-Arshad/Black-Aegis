# Detection Logic: T1021.007 - Cloud Services (T1021.007)
...
## Sigma Rule Template
```yaml
title: Detect Cloud Services (T1021.007) (T1021.007)
id: 3d565321-3ca1330c
status: experimental
description: Detects Cloud Services (T1021.007) technique
references:
...
| search CommandLine="*T1021.007*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1021.007"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1021.007"
```
