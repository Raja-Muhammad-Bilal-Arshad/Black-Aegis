# Detection Logic: T1563.001 - SSH Hijacking (T1563.001)
...
## Sigma Rule Template
```yaml
title: Detect SSH Hijacking (T1563.001) (T1563.001)
id: 51419eb0-722c195e
status: experimental
description: Detects SSH Hijacking (T1563.001) technique
references:
...
| search CommandLine="*T1563.001*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1563.001"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1563.001"
```
