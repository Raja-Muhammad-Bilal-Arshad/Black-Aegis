# Detection Logic: T1080 - Taint Shared Content (T1080)
...
## Sigma Rule Template
```yaml
title: Detect Taint Shared Content (T1080) (T1080)
id: 1b7dd25c-8482fb1c
status: experimental
description: Detects Taint Shared Content (T1080) technique
references:
...
| search CommandLine="*T1080*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1080"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1080"
```
