...
# Technique: T1563 - Remote Service Session Hijacking (T1563)
...
echo "[*] Black Aegis - T1563 Lateral Movement"
echo "[*] Target: $TARGET"
...
case "T1563" in
    ...
    T1570)
        ...
        ;;
    *)
        echo "[+] Lateral movement via Remote Service Session Hijacking (T1563)"
