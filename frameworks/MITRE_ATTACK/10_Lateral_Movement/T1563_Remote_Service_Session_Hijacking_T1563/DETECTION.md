# Detection Logic: T1563 - Remote Service Session Hijacking (T1563)
...
## Sigma Rule Template
```yaml
title: Detect Remote Service Session Hijacking (T1563) (T1563)
id: 1586cb0e-16ca4447
status: experimental
description: Detects Remote Service Session Hijacking (T1563) technique
references:
...
| search CommandLine="*T1563*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1563"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1563"
```
