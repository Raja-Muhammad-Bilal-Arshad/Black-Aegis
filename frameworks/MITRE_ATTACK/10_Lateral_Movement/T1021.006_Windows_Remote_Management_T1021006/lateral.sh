...
# Technique: T1021.006 - Windows Remote Management (T1021.006)
...
echo "[*] Black Aegis - T1021.006 Lateral Movement"
echo "[*] Target: $TARGET"
...
case "T1021.006" in
    ...
    T1570)
        ...
        ;;
    *)
        echo "[+] Lateral movement via Windows Remote Management (T1021.006)"
