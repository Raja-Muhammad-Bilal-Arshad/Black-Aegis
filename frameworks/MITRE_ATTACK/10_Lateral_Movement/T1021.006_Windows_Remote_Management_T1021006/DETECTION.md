# Detection Logic: T1021.006 - Windows Remote Management (T1021.006)
...
## Sigma Rule Template
```yaml
title: Detect Windows Remote Management (T1021.006) (T1021.006)
id: 2e14394b-3d5c72ed
status: experimental
description: Detects Windows Remote Management (T1021.006) technique
references:
...
| search CommandLine="*T1021.006*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1021.006"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1021.006"
```
