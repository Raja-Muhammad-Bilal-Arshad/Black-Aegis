# Detection Logic: T1021.005 - VNC (T1021.005)
...
## Sigma Rule Template
```yaml
title: Detect VNC (T1021.005) (T1021.005)
id: 9119be0f-470ea209
status: experimental
description: Detects VNC (T1021.005) technique
references:
...
| search CommandLine="*T1021.005*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1021.005"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1021.005"
```
