# Detection Logic: T1021 - Remote Services (T1021)
...
## Sigma Rule Template
```yaml
title: Detect Remote Services (T1021) (T1021)
id: 3c2f966b-7a4ee027
status: experimental
description: Detects Remote Services (T1021) technique
references:
...
| search CommandLine="*T1021*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1021"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1021"
```
