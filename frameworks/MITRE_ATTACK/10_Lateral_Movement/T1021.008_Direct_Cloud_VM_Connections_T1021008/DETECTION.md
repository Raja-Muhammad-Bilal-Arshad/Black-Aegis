# Detection Logic: T1021.008 - Direct Cloud VM Connections (T1021.008)
...
## Sigma Rule Template
```yaml
title: Detect Direct Cloud VM Connections (T1021.008) (T1021.008)
id: de66447b-08395ad5
status: experimental
description: Detects Direct Cloud VM Connections (T1021.008) technique
references:
...
| search CommandLine="*T1021.008*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1021.008"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1021.008"
```
