...
# Technique: T1021.008 - Direct Cloud VM Connections (T1021.008)
...
echo "[*] Black Aegis - T1021.008 Lateral Movement"
echo "[*] Target: $TARGET"
...
case "T1021.008" in
    ...
    T1570)
        ...
        ;;
    *)
        echo "[+] Lateral movement via Direct Cloud VM Connections (T1021.008)"
