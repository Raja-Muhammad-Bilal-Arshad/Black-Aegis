...
# Technique: T1021.001 - Remote Desktop Protocol (T1021.001)
...
echo "[*] Black Aegis - T1021.001 Lateral Movement"
echo "[*] Target: $TARGET"
...
case "T1021.001" in
    ...
    T1570)
        ...
        ;;
    *)
        echo "[+] Lateral movement via Remote Desktop Protocol (T1021.001)"
