# Detection Logic: T1021.001 - Remote Desktop Protocol (T1021.001)
...
## Sigma Rule Template
```yaml
title: Detect Remote Desktop Protocol (T1021.001) (T1021.001)
id: 518a2d9d-5fb8cf96
status: experimental
description: Detects Remote Desktop Protocol (T1021.001) technique
references:
...
| search CommandLine="*T1021.001*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1021.001"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1021.001"
```
