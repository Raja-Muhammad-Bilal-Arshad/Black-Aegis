# Detection Logic: T1021.004 - SSH (T1021.004)
...
## Sigma Rule Template
```yaml
title: Detect SSH (T1021.004) (T1021.004)
id: 6538331a-0d3296b7
status: experimental
description: Detects SSH (T1021.004) technique
references:
...
| search CommandLine="*T1021.004*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1021.004"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1021.004"
```
