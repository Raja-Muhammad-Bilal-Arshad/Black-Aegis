# Detection Logic: T1029 - Scheduled Transfer (T1029)
...
## Sigma Rule Template
```yaml
title: Detect Scheduled Transfer (T1029) (T1029)
id: 36743c4d-2f01ba6b
status: experimental
description: Detects Scheduled Transfer (T1029) technique
references:
...
| search CommandLine="*T1029*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1029"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1029"
```
