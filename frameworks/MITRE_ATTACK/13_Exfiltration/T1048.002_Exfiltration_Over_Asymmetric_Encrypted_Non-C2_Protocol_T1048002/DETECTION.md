# Detection Logic: T1048.002 - Exfiltration Over Asymmetric Encrypted Non-C2 Protocol (T1048.002)
...
## Sigma Rule Template
```yaml
title: Detect Exfiltration Over Asymmetric Encrypted Non-C2 Protocol (T1048.002) (T1048.002)
id: 05db2aa1-819c348b
status: experimental
description: Detects Exfiltration Over Asymmetric Encrypted Non-C2 Protocol (T1048.002) technique
references:
...
| search CommandLine="*T1048.002*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1048.002"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1048.002"
```
