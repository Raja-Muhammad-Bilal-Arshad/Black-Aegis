# Detection Logic: T1048 - Exfiltration Over Alternative Protocol (T1048)
...
## Sigma Rule Template
```yaml
title: Detect Exfiltration Over Alternative Protocol (T1048) (T1048)
id: 553f0907-de11daf2
status: experimental
description: Detects Exfiltration Over Alternative Protocol (T1048) technique
references:
...
| search CommandLine="*T1048*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1048"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1048"
```
