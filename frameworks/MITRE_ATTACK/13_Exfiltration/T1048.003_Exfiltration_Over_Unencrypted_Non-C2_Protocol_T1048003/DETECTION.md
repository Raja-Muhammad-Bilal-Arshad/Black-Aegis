# Detection Logic: T1048.003 - Exfiltration Over Unencrypted Non-C2 Protocol (T1048.003)
...
## Sigma Rule Template
```yaml
title: Detect Exfiltration Over Unencrypted Non-C2 Protocol (T1048.003) (T1048.003)
id: 0d04da38-e65df278
status: experimental
description: Detects Exfiltration Over Unencrypted Non-C2 Protocol (T1048.003) technique
references:
...
| search CommandLine="*T1048.003*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1048.003"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1048.003"
```
