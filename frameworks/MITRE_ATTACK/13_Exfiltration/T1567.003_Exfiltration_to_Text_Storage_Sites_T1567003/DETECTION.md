# Detection Logic: T1567.003 - Exfiltration to Text Storage Sites (T1567.003)
...
## Sigma Rule Template
```yaml
title: Detect Exfiltration to Text Storage Sites (T1567.003) (T1567.003)
id: b6c8fcf3-3aa3a8c2
status: experimental
description: Detects Exfiltration to Text Storage Sites (T1567.003) technique
references:
...
| search CommandLine="*T1567.003*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1567.003"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1567.003"
```
