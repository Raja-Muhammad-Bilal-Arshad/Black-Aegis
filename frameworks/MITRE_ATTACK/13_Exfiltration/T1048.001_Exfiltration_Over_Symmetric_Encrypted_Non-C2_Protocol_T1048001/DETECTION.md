# Detection Logic: T1048.001 - Exfiltration Over Symmetric Encrypted Non-C2 Protocol (T1048.001)
...
## Sigma Rule Template
```yaml
title: Detect Exfiltration Over Symmetric Encrypted Non-C2 Protocol (T1048.001) (T1048.001)
id: 72189855-2255e7eb
status: experimental
description: Detects Exfiltration Over Symmetric Encrypted Non-C2 Protocol (T1048.001) technique
references:
...
| search CommandLine="*T1048.001*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1048.001"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1048.001"
```
