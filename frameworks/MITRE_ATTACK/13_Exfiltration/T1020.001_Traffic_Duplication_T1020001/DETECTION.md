# Detection Logic: T1020.001 - Traffic Duplication (T1020.001)
...
## Sigma Rule Template
```yaml
title: Detect Traffic Duplication (T1020.001) (T1020.001)
id: e1421b08-e3b09c39
status: experimental
description: Detects Traffic Duplication (T1020.001) technique
references:
...
| search CommandLine="*T1020.001*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1020.001"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1020.001"
```
