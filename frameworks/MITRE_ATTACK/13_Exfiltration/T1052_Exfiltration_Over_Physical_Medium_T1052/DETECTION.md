# Detection Logic: T1052 - Exfiltration Over Physical Medium (T1052)
...
## Sigma Rule Template
```yaml
title: Detect Exfiltration Over Physical Medium (T1052) (T1052)
id: 77740460-4be54146
status: experimental
description: Detects Exfiltration Over Physical Medium (T1052) technique
references:
...
| search CommandLine="*T1052*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1052"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1052"
```
