# Detection Logic: T1020 - Automated Exfiltration (T1020)
...
## Sigma Rule Template
```yaml
title: Detect Automated Exfiltration (T1020) (T1020)
id: f063b54d-cd7e6d28
status: experimental
description: Detects Automated Exfiltration (T1020) technique
references:
...
| search CommandLine="*T1020*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1020"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1020"
```
