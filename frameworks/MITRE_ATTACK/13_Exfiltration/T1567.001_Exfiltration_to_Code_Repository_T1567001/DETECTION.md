# Detection Logic: T1567.001 - Exfiltration to Code Repository (T1567.001)
...
## Sigma Rule Template
```yaml
title: Detect Exfiltration to Code Repository (T1567.001) (T1567.001)
id: 77877ead-32649d9b
status: experimental
description: Detects Exfiltration to Code Repository (T1567.001) technique
references:
...
| search CommandLine="*T1567.001*"
| stats count by ComputerName, CommandLine
```

### Elastic
```json
{"query": {"match": {"process.command_line": "T1567.001"}}}
```
...
SecurityEvent
| where EventID == 4688
| where CommandLine contains "T1567.001"
```
